...
public struct Float3 {
	...
	public Float3 Scaled ( float x, float y, float z ) => new Float3( x * this.x, y * this.y, z * this.z );
	public Float3 Scaled ( Float3 scale ) => Scaled( new Float3( scale.x, scale.y, scale.z ) );
