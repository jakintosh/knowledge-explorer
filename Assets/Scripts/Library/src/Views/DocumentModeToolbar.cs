	...
	public class DocumentModeToolbar : View {
		...
		protected override void OnInitialize () {
			...
			_mode = new Observable<DocumentModes>(
				...
				onChange: mode => {
					_editIcon.color = mode == DocumentModes.Edit ? Colors.Action : Colors.Foreground;
					_reorderIcon.color = mode == DocumentModes.Reorder ? Colors.Action : Colors.Foreground;
					_readIcon.color = mode == DocumentModes.Read ? Colors.Action : Colors.Foreground;
